...
void TestTree(const string &db_filename, const string &seq_filename, TreeType &a_tree) {
	...
	int two_ = 0;
	int four_a_ = 0;
	int four_successful_reference_ = 0; // var to be passed by reference to hold successful find calls
	int four_total_reference_ = 0;	// var to be passed by reference to hold total find calls
	int five_a_ = 0;
	int five_successful_reference_ = 0; // var to be passed by reference to hold successful remove calls
	int five_total_reference_ = 0;	// var to be passed by reference to hold total remove calls
	int five_current_path_reference_ = 0; // var to be passed by reference to hold total remove calls from current function call
	int six_a_ = 0;
	float three_a_ = 0.0;
	float three_b_ = 0.0;
	float four_b_ = 0.0;
