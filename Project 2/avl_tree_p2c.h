...
// of insertion, deletion, and searching is better than a regular BST. Has double rotation 
// implementing for balancing the tree.
...
public:
	...
	/**
	 * OVERLOADED: Find the smallest item in the tree.
	 * Throw UnderflowException if empty.
	 */
...
private:
	...
	*****************************************************/
	...
	{
        // "Right Left Rotation", rotate right, and then rotate left
		// Perform a right rotation with k3->left
		...
		k3->left = k2;
		// Perform a left rotation with k3
		AvlNode *k1 = k3->left;
		k3->left = k1->right;
		k1->right = k3;
	...
	{
        // "Right Left Rotation", rotate right, and then rotate left
		// Perform a left rotation with k1->right
		...
		// Perform a right rotation with k1
		AvlNode *k2 = k1->right;
		k1->right = k2->left;
		k2->left = k1;
		k1->height = max( height( k1->left ), height( k1->right ) ) + 1;
